...
$returnArray = array(
  'ctrl' => array(
    'title' => 'LLL:EXT:quick_shop/Ressources/Private/Language/locallang_db.xml:tx_quickshop_material',
    'label' => 'title',
    'tstamp' => 'tstamp',
    'crdate' => 'crdate',
    'cruser_id' => 'cruser_id',
  ...
  'columns' => array(
    ...
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:quick_shop/Ressources/Private/Language/locallang_db.xml:tx_quickshop_material.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:quick_shop/Ressources/Private/Language/locallang_db.xml:tx_quickshop_material.uid_parent',
      'config' => array(
        'type' => 'select',
        'size' => 1,
        'minitems' => 0,
...
if ( $bool_LL )
{
  ...
  $returnArray[ 'columns' ][ 'title_lang_ol' ] = array
    (
    'exclude' => 0,
    'label' => 'LLL:EXT:quick_shop/Ressources/Private/Language/locallang_db.xml:tx_quickshop_material.title_lang_ol',
    'config' => array(
      'type' => 'input',
      'size' => '30',
    )
